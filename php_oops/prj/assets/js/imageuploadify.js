	...
	$.fn.imageuploadify = function(opts) {
		...
		this.each(function() {
			...
			const readingFile = (id, file) => {
				...
				let container = $(`<div class='imageuploadify-container'><button type='button'class='btn btn-danger fa-solid fa-xmark'></button><div class='imageuploadify-details'><span>${file.name}</span><span>${file.type}</span><span>${file.size}</span></div></div>`);
